...
uv run inference.py --base_model Qwen/Qwen2.5-7B-Instruct --adapter_model tutor369/Qwen2.5-7B-Instruct-lora-v1 --data_path dataset/ 
...
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v4 --data_path dataset/ --max_new_tokens 1024 
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v5 --data_path dataset/ 
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v6 --data_path dataset/ 
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v7 --data_path dataset/ 
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v8 --data_path dataset/ 
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v9 --data_path dataset/ 
uv run inference.py --base_model Qwen/Qwen2.5-1.5B-Instruct --adapter_model tutor369/Qwen2.5-1.5B-Instruct-lora-v10 --data_path dataset/
